...
namespace WebApplication.Pages.Metrics
{
    public class ExceptionsModel : PageModel
    {
        ...
        private readonly IOptions<AppConfig> appSetting;
        private readonly FetchDataService _fetchDataService;
        public ExceptionsModel(IOptions<AppConfig> options,FetchDataService fetchDataService)
        {
        ...
        public async Task OnGet()
        {
            ...
            List<Exceptions> addOn = await _fetchDataService.getData<Exceptions>(oldStamp, newStamp); // Get data
