...
namespace WebApplication.Pages.Metrics
{
    public class ContentionsModel : PageModel
    {
        ...
        public ContentionsModel(IOptions<AppConfig> options,FetchDataService fetchDataService)
        {
        ...
        public async Task OnGet()
        {
            ...
            // Geting new data 
            List<Contention> addOn = await _fetchDataService.getData<Contention>(oldStamp, newStamp);
