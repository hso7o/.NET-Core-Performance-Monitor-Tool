...
namespace WebApplication.Pages.Metrics
{
    public class HTTP_RequestsModel : PageModel
    {
        ...
        public HTTP_RequestsModel(FetchDataService fetchDataService,IOptions<AppConfig> options)
        {
        ...
        public async Task OnGet()
        {
            ...
            List<Http_Request> addOn = await _fetchDataService.getData<Http_Request>(oldStamp, newStamp); // Get data
